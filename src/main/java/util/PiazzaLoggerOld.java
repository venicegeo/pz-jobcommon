...
public class PiazzaLoggerOld {
	...
	private final static Logger LOGGER = LoggerFactory.getLogger(PiazzaLoggerOld.class);
	private ThreadPoolTaskExecutor executor = new ThreadPoolTaskExecutor();

	/**
	 * Default constructor, required for bean instantiation.
	 */
	public PiazzaLoggerOld() {
	}
	 ...
	 */
	public PiazzaLoggerOld(String loggerServiceUrl, String serviceName) {
