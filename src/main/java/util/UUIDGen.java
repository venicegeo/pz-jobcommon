...
/**
 * UUIDGen class that calls the Piazza Core UUIDGen service and returns a
 * new ID. If the service is down, an ID is generated locally. 
 * 
 * @author mlynum, rorf
 * @version 1.0
 */
...
public class UUIDGen {
    ...
    private final static Logger LOG = LoggerFactory.getLogger(UUIDGen.class);

    public UUIDGen(String uuidServiceUrl) {
	this.uuidServiceUrl = uuidServiceUrl;
    }
    
    @PostConstruct
    public void init() {
	LOG.info("UUIDGen initialized");
